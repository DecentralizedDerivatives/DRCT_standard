...
contract Factory {
    ...
    *@param _token The address of a token to be used  ? you used ot have comments for two tokens?
    */
    ...
    */
    ...
    /**
    *@dev Gets long or short token address based on the _start_date?
    *@param _start_date contract start date?
    *@param long if true the token is long? 
    *@return returns token address for short or long token depending on what is specified in _long?
    */
